window.alert("𝘾𝙤𝙨𝙢𝙞𝙘𝐁𝐎𝐓 has connected successfully!\n\nConnected Version: ①.⑥.④");
console.info("𝘾𝙤𝙨𝙢𝙞𝙘𝐁𝐎𝐓 has connected successfully!");
console.group();
console.log("𝘾𝙤𝙨𝙢𝙞𝙘𝐁𝐎𝐓 Version: ①.⑥.④");
...
setTimeout(function(){e++;socket.emit('talk',{text:"- - <h3>𝘾𝙤𝙨𝙢𝙞𝙘𝐁𝐎𝐓</h3><h5>⌬ Developed by: Cosmic ⌬</h5> <hr /><li>@hub</li> <hr /><b>✰Commands:✰</b><hr /><li>@joke</li><br /> <li>@fact</li><br /> <li>@bees</li><br /> <li>@linux</li><br /> <li>@triggered</li><br /> <li>@pawn</li><br /> <li>@video [URL]</li><br /> <li>@emotes</li><br /> <li>@colors</li><br /> <hr /><h6>Commands Page 1.</h6><hr />"})}, 500)}});var e = 0;
socket.on('talk',function(data){if(data.text=='@cmds 2'){
setTimeout(function(){e++;socket.emit('talk',{text:"- - <h3>𝘾𝙤𝙨𝙢𝙞𝙘𝐁𝐎𝐓</h3><h5>⌬ Developed by: Cosmic ⌬</h5> <hr /><li>@hub</li> <hr /><b>✰Commands:✰</b><hr /><li>@bonzibuddy</li><br /> <li>@bonzibuddy 2</li><br /> <li>@cyberpunk</li><br /> <li>@faceoff</li><br /> <li>@bigsmoke</li><br /> <li>@vaporwave</li><br /> <li>@unvaporwave</li><br /> <li>@gabe</li><br /> <li>@muteunknown</li><br /> <li>@fakeerrors</li><br /> <hr /><h6>Commands Page 2.</h6><hr />"})}, 500)}});var e = 0;
...
setTimeout(function(){e++;socket.emit('talk',{text:"- - <hr /><h4>⚜My Discord Server:</h4> <br /><li>https://bit.ly/3C1wDDO </li><br /><hr /> <h4>📝My Pastebin Profile:</h4> <br /><li>https://bit.ly/3k1DiYM </li><br /></li><hr /> <h6>Links.</h6><hr />"})}, 700)}});var e = 0;
...
socket.on('talk',function(data){if(data.text=='@botver'){e++;socket.emit('talk',{text: '- - <h3>𝘾𝙤𝙨𝙢𝙞𝙘𝐁𝐎𝐓</h3><div><h4>Version ①.⑥.④</h4><br><hr>'})}});var e = 0;
